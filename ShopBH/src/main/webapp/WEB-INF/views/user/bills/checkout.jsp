...
-->
	<div class="row">
		<div id="sidebar" class="span3">
			<div class="well well-small">
				...
				<li><a href="<c:url value="/san-pham/1" />"><span
								class="icon-circle-blank"></span> Balo nam</a></li>
					<li><a href="<c:url value="/san-pham/2" />"><span
								class="icon-circle-blank"></span> Túi xách nam</a></li>
					<li><a href="<c:url value="/san-pham/3" />"><span
								class="icon-circle-blank"></span> Balo nữ</a></li>
					<li><a href="<c:url value="/san-pham/4" />"><span
								class="icon-circle-blank"></span> Túi xách nữ</a></li>
		...
		<h4 class="title cntr">
			<span  class="text">
				⛪ Ngân Hàng VietcomBank <br> <br>
					✅ STK: 103 270 3333 <br> <br>
				✅ CTK: KINGBAG <br> <br>

 				⛪ Ngân Hàng MB  <br> <br>
					✅ STK: 6666 2003 999 <br> <br>
				✅ CTK: NGO THI XUAN <br> <br>

			</span>
			<img
						src="<c:url value="/assets/user/img/5tlkd.webp" />"
